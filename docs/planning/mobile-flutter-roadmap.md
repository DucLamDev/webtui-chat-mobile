...
| M11.14 | Direct APK download fallback | M11.11 | Upload APK lên `download.webtui.vn/downloads/files/android/stable/`, có checksum SHA-256, version, release notes và hướng dẫn cài | P0 |
...
| M12.13 | APK download public fallback | M11.14 | Nếu chưa public CH Play, người dùng vẫn tải được APK signed tại `download.webtui.vn/download/` kèm checksum | P0 |
...
8. Upload APK fallback lên `download.webtui.vn/downloads/files/android/stable/` kèm SHA-256 checksum và release notes.
...
Android MVP nội bộ nên được phát hành sau M8 qua Firebase App Distribution hoặc APK signed trên `download.webtui.vn/download/`. Production “đầy đủ toàn bộ chức năng” chỉ đạt khi M9-M13 và các backend backlog P0 hoàn thành.
